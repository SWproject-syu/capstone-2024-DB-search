...
// 데이터 넣기 curl -X GET "http://localhost:3000/api/healthsupplement/data/healthsupplementDataInsert"
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    const filePath = path.resolve("./src/pages/api/healthsupplement/data", "healthsupplementData.json");
