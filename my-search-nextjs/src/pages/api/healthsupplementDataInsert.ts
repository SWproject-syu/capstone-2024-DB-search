...
// 데이터 비우기 curl -X DELETE "http://localhost:9200/healthsupplement"
// 데이터 아무거나 3개 가져오기
// curl -X GET "http://localhost:9200/healthsupplement/_search?size=3" -H 'Content-Type: application/json' -d'
// {
//   "query": {
//     "match_all": {}
//   }
